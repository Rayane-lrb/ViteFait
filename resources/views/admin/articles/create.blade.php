<x-site-layout>
    <div class="p-5">
        <h1 class="text-2xl text-orange-500 font-bold">Créer un article</h1>
        <form action="/admin/articles" method="post">
            ...
            <div class="flex flex-col gap-4">
                <div class="flex flex-col">
                    ...
                    <input name="title" type="text" class="rounded" value="{{old('title')}}">
                    @error('title')
                ...
                <div class="flex flex-col">
                    ...
                    <textarea name="text"  cols="60" rows="30" class="rounded">{{old('text')}}</textarea>
                    @error('text')
                    <p class="text-red-400">{{$message}}</p>
                    @enderror
                </div>
                ...
                <div class="ml-auto">
                    ...
                    <button type="submit" class="text-orange-400 bg-[#243447]/70 p-2 px-2 rounded-xl hover:text-orange-500 hover:bg-[#1b2a3e] transition">Créer</button>
                </div>
            </div>
        </form>
    </div>
